        ...
        {questions.map((i, index) => {
          return (
            <div className="bg-white shadow-lg border border-[#E0F7FA] w-full rounded-3xl px-6 py-4 flex flex-col items-start">
              <button className="bg-[#C6FF00] text-[#333333] px-4 py-2 rounded-md mb-4">
                {i.button}
              </button>
        ...
        <div className="hero-flavour h-full w-[55vw] mr-8 relative">
          ...
          <div className="image bg-[#F6A226] h-[80vh] ml-[5vw] relative rounded-3xl">
            <img
              src={whitePeach}
              alt="GoToFlavour"
              className="h-[92vh] absolute -top-20"
            />
            <div className="p-4 bg-[#70707033] absolute bottom-0 rounded-bl-3xl rounded-br-3xl">
              <h2 className="peachText text-[10vh] font-bold text-white leading-none capitalize">
                Pearl White Peach
              </h2>
            </div>
          </div>
                ...
                <div
                  className={
                    index == 1
                      ...
                      : "h-1/2 mt-8 bg-[#E52184] rounded-3xl relative"
                  }
                >
                  <img
                    src={i.imgSrc}
            ...
            {flavourCard01.map((i, index) => {
              return (
                <div
                  className={
                    index == 1
                      ? " h-[51vh] bg-[#009689] rounded-3xl mt-8 relative "
                      : "h-1/2 mt-8 bg-[#28B8CE] rounded-3xl relative "
                  }
                >
                  <img
                    src={i.imgSrc}
